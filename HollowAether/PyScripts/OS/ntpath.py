...
def splitext(p):
    return genericpath.splitext(p, sep, altsep, extsep)
splitext.__doc__ = genericpath.splitext.__doc__
...
def relpath(path, start=curdir):
    ...
    start_is_unc, start_prefix, start_list = _abspathsplit(start)
    path_is_unc, path_prefix, path_list = _abspathsplit(path)
